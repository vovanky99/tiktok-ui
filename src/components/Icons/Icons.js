...
export const FollowIcon = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const FollowActiveIcon = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LiveActiveIcon = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
